...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var webhoolMIddlewere, payload, cartRouter;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                webhoolMIddlewere = body_parser_1.default.json({
                    verify: function (req, _, buffer) {
                        req.rawBody = buffer;
                    },
                });
                app.post("/api/webhooks/stripe", webhoolMIddlewere, webhooks_1.stripeWebhookHandler);
