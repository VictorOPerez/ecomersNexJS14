...
const Page = async ({ searchParams }: PageProps) => {
  ...
  const { user } = await getServerSiseUser(nextCookies);
  console.log(user);
  ...
  return (
    <main className="relative lg:min-h-full">
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-4xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
        <div className="lg:col-start-2">
          ...
          {order._isPaid ? (
            <p className=" mt-2 text-base text-muted-foreground">
              Your order was processed and your assets are available to dowload
            ...
            <p className=" mt-2 text-base text-muted-foreground">
              ...
              So hang tinght and we&apos;ll send you confirmation very soon!
            </p>
          )}
